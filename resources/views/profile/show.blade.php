    ...
    <div class="min-h-full">
                            ...
                            <div class="relative ml-3">
                                <div>
                                    <button type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                        ...
                                        <img class="size-8 rounded-full" src="{{Storage::url($user->profile_image)}}" alt="">
                                    </button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        <div class="shrink-0">
                            <img class="size-10 rounded-full" src="{{Storage::url($user->profile_image)}}" alt="">
                        </div>
                        <div class="ml-3">
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                ...
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">Welcome {{ $user->email }} </h1>
            </div>
        </header>
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
